...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=ReportCategoryResponse)
async def create_report_category(category_data: ReportCategoryCreate, db: AsyncSession = Depends(get_db)):
